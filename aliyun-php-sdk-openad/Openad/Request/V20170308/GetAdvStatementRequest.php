...
class GetAdvStatementRequest extends \RoaAcsRequest
{
    function  __construct()
    {
        parent::__construct("OA", "2017-03-08", "GetAdvStatement");
        $this->setUriPattern("/advstatement/query/[StatementName]/[StartTime]/[EndTime]");
        $this->setMethod("GET");
    }
