...
class GetDspMediaStatementDetailRequest extends \RoaAcsRequest
{
    function  __construct()
    {
        parent::__construct("OA", "2017-03-08", "GetDspMediaStatementDetail");
        $this->setUriPattern("/statistics/media/query/[StartTime]/[EndTime]");
        $this->setMethod("GET");
    }
