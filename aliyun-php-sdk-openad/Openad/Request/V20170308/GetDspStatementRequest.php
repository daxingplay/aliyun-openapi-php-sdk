...
class GetDspStatementRequest extends \RoaAcsRequest
{
    function  __construct()
    {
        parent::__construct("OA", "2017-03-08", "GetDspStatement");
        $this->setUriPattern("/dspstatement/query/[StatementName]/[StartTime]/[EndTime]");
        $this->setMethod("GET");
    }
